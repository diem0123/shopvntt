			...
			if($subcat == "") $subcat = 0;
				try {
					$ArrayData  = array( 1 => array(1 => "STITLE".$pre, 2 => $commonname),
										...
										5 => array(1 => "DATE_POST", 2 => date('Y-m-d H:i:s')),
										6 => array(1 => "DATE_UPDATED", 2 => date('Y-m-d H:i:s')),
										7 => array(1 => "ID_TYPE", 2 => $idtype),
										8 => array(1 => "POST_BY", 2 => $_SESSION['ID_CONSULTANT']),
										9 => array(1 => "PICTURE", 2 => $filesucess),
										10 => array(1 => "ID_CAT", 2 => $typecat),
										11 => array(1 => "ID_CAT_SUB", 2 => $subcat),
										12 => array(1 => "HOME", 2 => $HOME),
										13 => array(1 => "TIEUDIEM", 2 => $tieudiem)
										
									  );
							  
					$idc = $common->InsertDB($ArrayData,"common");
