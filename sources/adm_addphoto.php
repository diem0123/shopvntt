			...
			if($subcat == "") $subcat = 0;
				try {
					$ArrayData  = array( 1 => array(1 => "STITLE".$pre, 2 => $photoname),
										...
										5 => array(1 => "DATE_POST", 2 => date('Y-m-d')),
										6 => array(1 => "DATE_UPDATED", 2 => date('Y-m-d')),
										...
										12 => array(1 => "BIG_IMG", 2 => $file2)
										
									  );
							  
					$idc = $common->InsertDB($ArrayData,"photos");
