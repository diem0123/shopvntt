<?php
	...
	$submenu->set('sub','');
     ...
     $main = & new Template('add_mailsmtp'); 	 
		...
		$emailfrom = $itech->input['emailfrom'];
	...
	$main->set("title", $pagetitle);
		...
		elseif($ac=="e" && $submit == "" && $ids) {
					...
					$main->set('emailfrom', $catinfo['FROM_EMAIL']);
		...
		// Begin update data
				...
				try {
					$ArrayData = array( 
										...
										2 => array(1 => "FROM_EMAIL", 2 => $emailfrom),
										3 => array(1 => "SMTP_SERVER", 2 => $hostname),
										4 => array(1 => "SMTP_PORT", 2 => $port),
										5 => array(1 => "SMTP_TYPE", 2 => $smtptype),
										6 => array(1 => "SMTP_USER", 2 => $emailsmtp),
										7 => array(1 => "SMTP_PASS", 2 => $pass)
