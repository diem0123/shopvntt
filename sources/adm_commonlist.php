<?php
	...
	$main->set('submenu2',"");				 
		...
		// setup for paging			
			...
			{								                   
					if($rs['STITLE'.$pre] == "") $commonname = $rs['STITLE'];
					else $commonname = $rs['STITLE'.$pre];
					$fet_box->set( "commonname", $commonname);
			...
			$list_type_category = $print_2->GetDropDown($typecat, "common_cat", "ID_TYPE = '".$idtype."' AND STATUS = 'Active' "  , "ID_CAT", "SNAME", "IORDER");//.$pre
			...
			$list_commontype = $print_2->GetDropDown($idtype, "common_type","STATUS = 'Active'" ,"ID_TYPE", "SNAME", "IORDER");	//.$pre
			$list_type_category = $print_2->GetDropDown($typecat, "common_cat", "ID_TYPE = '".$idtype."' AND STATUS = 'Active' "  , "ID_CAT", "SNAME", "IORDER");//.$pre			
			$list_sub_category = $print_2->GetDropDown($idsubcat, "common_cat_sub", "ID_CAT = '".$typecat."'"  , "ID_CAT_SUB", "SNAME", "IORDER");//.$pre
