...
if($_SESSION['dv_Type']=="phone"){
	...
	// get san pham tieu bieu
	$listsptb = $print->listsptb($pre,$idmnselected);
	$temp_contents->set('listsptb', $listsptb);
	// get hot news
	$newsrun = $print->getnews_ud_home();
	$temp_contents->set('news_uudai', $newsrun);
	//get tin tuc uu dai lien quan
	$news_ud_lq = $print->getnews_ud_lq();
	$temp_contents->set('news_ud_lq',$news_ud_lq);
	//kiến thức làm đẹp
	$lamdep = $print->getnews_kienthuc_lamdep(26);
	$temp_contents->set('lamdep',$lamdep);
	//kiến thức chăm con
	$chamcon = $print->getnews_kienthuc_lamdep(27);
	$temp_contents->set('chamcon',$chamcon);
	//get ý kiến khách hàng
	$ykien = $print->get_ykien(29);
	$temp_contents->set('ykien',$ykien);
	//get video clip 
