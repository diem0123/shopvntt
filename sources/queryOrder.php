...
// get data tu don hang can query
$idpay = $_GET['idpay'];
...
$infopay = $common->getInfo("payments","ID_PAYMENT = '".$idpay."'");
$transactionID = $infopay['MERCHTXNREF'];
$time = $infopay['TIME123PAY'];
$status = $infopay['STATUS123PAY'];
$ticket = $infopay['TICKET123PAY'];
$clientIP = $infopay['IP'];
}
...
{
	$transStatus = "Th&ocirc;ng s&#7889; URL kh&ocirc;ng ph&ugrave; h&#7907;p!";
	//echo 'Invalid url';
	exit;	
}
		...
		try
		{
			...
			if($result['httpcode'] ==  200)
			{
				...
				*/
				...
				//echo 'Call service queryOrder fail: Order is processing. Please waiting some munite and check your order history list';
				//$transStatus = 'Call service queryOrder fail: Order is processing. Please waiting some munite and check your order history list';
				$transStatus = "D&#7883;ch v&#7909;   &#273;&#7863;t h&agrave;ng    g&#7885;i kh&ocirc;ng th&#7875; x&#7917; l&yacute;, vui l&ograve;ng ki&#7875;m tra l&#7841;i";
			}
		}catch(Exception $e)
		{
