...
class function_coppy
{
		...
		{
			define('WATERMARK_OVERLAY_IMAGE', $_SERVER['DOCUMENT_ROOT'].'/gcfood/wysiwyg/dongdau/watermark.png');
		...
		*/
		...
		{
			echo $_SERVER['DOCUMENT_ROOT'].'/gcfood/images/bin/imagenews_root/';
			define('UPLOADED_IMAGE_DESTINATION', $_SERVER['DOCUMENT_ROOT'].'/gcfood/images/bin/imagenews_root/');//Images input
			define('PROCESSED_IMAGE_DESTINATION',$_SERVER['DOCUMENT_ROOT'].'/gcfood/images/bin/imagenews/');//Images output
