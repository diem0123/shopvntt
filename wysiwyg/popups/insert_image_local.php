...
<?php $base_url = $_SERVER['DOCUMENT_ROOT'].'/ost/'; ?>
<script type="text/javascript" src="../../js/jquery-1.7.2.min.js"></script>
<script type="text/javascript" src="../../js/common.js"></script>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"><input type="hidden" name="base_url" id="base_url" value="<?=$base_url?>">
<script type="text/javascript">
function getlibrary(page) {	
	//alert($("#base_url").val());
	$.ajax({
		url: 'http://localhost/ost/index.php',
		type: 'POST',
...
<span style="font-family: arial, verdana, helvetica; font-size: 11px; font-weight: bold;">Insert Image:</span><span style="font-family: arial, verdana, helvetica; font-size: 11px; "> Chọn ảnh Upload hoặc click vào ảnh bên phải để chèn link</span>
<div style="height:10px;"></div>
<table width="380" border="0" cellpadding="0" cellspacing="0" style="background-color: #F7F7F7; border: 2px solid #FFFFFF; padding: 5px;">
 <tr>
 	<td style="padding-bottom: 2px; padding-top: 0px; font-family: arial, verdana, helvetica; font-size: 11px;" width="80">Select Image:</td>
